  ...
  return (
    <main className="premium-landing">
      ...
      <section className="premium-hero">
        ...
        <div className="hero-product-stage" aria-hidden={false}>
      ...
      <section className="visit-prep-section" id="how-medi-guide-works">
      ...
      <section className="document-workflow-section">
        <div className="workflow-copy">
          ...
          <p>
            Move from upload to verification to a grounded explanation. The review step keeps names, values, units, and
            dates in your hands.
          </p>
        </div>
        <div className="doc-steps" aria-label="Document understanding workflow">
          ...
          <article className="doc-step">
            ...
            <div className="step-understand">
              <p>
                Hemoglobin helps carry oxygen. Your value is within the listed reference range on this report.
              </p>
      ...
      <section className="voice-workflow-section">
        <div className="workflow-copy">
          ...
          <p>
            Your voice becomes an editable transcript. MediGuide highlights medication names, numbers, units, and dates
            before anything is sent.
          </p>
        </div>
        <div className="voice-ui" aria-label="Voice transcript confirmation workflow">
          ...
          <div className="transcript-card">
            ...
            <p>
              Can you help me prepare a question about whether{" "}
              <mark>Amoxicillin</mark> at <mark>5 mg</mark> started on <mark>August 12</mark> could affect my lab
              values?
            </p>
      ...
      <section className="evidence-showcase-section">
        <div className="workflow-copy">
          ...
          <p>
            Evidence sits beside the explanation — with publisher, topic, review date, and the passage that supports the
            answer.
          </p>
        </div>
        <div className="evidence-sidebar-demo">
